...
{{-- ═══════════════════════════════════════════════════
     ALERT KRITIS — KITAS / Dokumen Expired
     ═══════════════════════════════════════════════════ --}}
...
<div class="row g-3 mb-4">
    ...
    <div class="col-6 col-md-3 sima-fade sima-fade--1">
        <a href="{{ route('mahasiswa.request.index') }}" class="sima-stat sima-stat--blue d-block text-decoration-none">
            ...
            <div class="sima-stat__delta sima-stat__delta--flat">
                <i class="fas fa-clock"></i> Menunggu validasi KLN
            </div>
        </a>
    </div>

    <div class="col-6 col-md-3 sima-fade sima-fade--2">
        <a href="{{ route('mahasiswa.profil.dokumen') }}" class="sima-stat sima-stat--red d-block text-decoration-none">
            ...
            <div class="sima-stat__delta sima-stat__delta--down">
                <i class="fas fa-arrow-up"></i> Tindakan segera diperlukan
            </div>
        </a>
    </div>
    ...
    <div class="col-6 col-md-3 sima-fade sima-fade--4">
        <a href="{{ route('mahasiswa.notifikasi') }}" class="sima-stat sima-stat--amber d-block text-decoration-none">
            ...
            <div class="sima-stat__delta sima-stat__delta--flat">
                <i class="fas fa-circle" style="font-size:6px"></i> Belum dibaca
            </div>
        </a>
    </div>
    ...
    <div class="col-md-5 sima-fade sima-fade--5">
        <div class="sima-card h-100">
            ...
            <div class="sima-card__body">
                ...
                <div class="sima-sch" onclick="window.location='{{ route('mahasiswa.jadwal') }}'">
                    ...
                    <div class="sima-sch__info">
                        ...
                        <div class="sima-sch__meta">
                            <i class="fas fa-map-marker-alt"></i> {{ $sch->ruangan }}
                            &nbsp;·&nbsp; {{ $sch->dosen }}
                        </div>
                    </div>
                ...
                @empty
                {{-- Dummy data jika belum ada data dari controller --}}
                <div class="sima-sch" onclick="window.location='{{ route('mahasiswa.jadwal') }}'">
                    ...
                    <div class="sima-sch__info">
                        ...
                        <div class="sima-sch__meta">
                            <i class="fas fa-map-marker-alt"></i> Gd. 4, Ruang 201 &nbsp;·&nbsp; Dr. Hendro Susanto
                        </div>
                    </div>
                </div>
                ...
                <div class="sima-sch" onclick="window.location='{{ route('mahasiswa.jadwal') }}'">
                    ...
                    <div class="sima-sch__info">
                        ...
                        <div class="sima-sch__meta">
                            <i class="fas fa-map-marker-alt"></i> Lab Komputer 3 &nbsp;·&nbsp; Budi Santoso, M.T.
                        </div>
                    </div>
                    <span class="sima-badge sima-badge--blue" style="flex-shrink:0">
                ...
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
                    ...
                    <span style="font-family:var(--f-mono);font-size:14px;font-weight:700;color:var(--c-green)">
                        {{ $attendanceRate ?? 87 }}%
                    </span>
                </div>
                <div class="sima-prog">
                    <div class="sima-prog__bar" data-w="{{ $attendanceRate ?? 87 }}"
                         style="background:linear-gradient(90deg,#059669,#34D399)"></div>
                </div>
                <div style="display:flex;justify-content:space-between;margin-top:7px">
                    <span style="font-size:11px;color:var(--c-text-3)">
                        <i class="fas fa-info-circle"></i> Minimal 80%
                    </span>
                    <span style="font-size:11px;color:var(--c-text-3)">
                        {{ $attendanceMet ?? 26 }} / {{ $attendanceTotal ?? 30 }} pertemuan
                    </span>
                </div>
            ...
            <div class="sima-card__body">
                <ul class="sima-timeline">
                    ...
                    <li class="sima-tl-item">
                        <div class="sima-tl-dot" style="background:{{ $act->bg }};color:{{ $act->color }}">
                ...
                <div style="padding:16px;background:var(--c-surface-2);border-radius:13px;border:1px solid var(--c-border-soft)">
                    <div style="display:flex;align-items:center;gap:12px;margin-bottom:14px">
                        <div class="sima-avatar"
                             style="width:46px;height:46px;border-radius:12px;font-size:17px;background:linear-gradient(135deg,#2563EB,#7C3AED)">
    ...
    <div class="col-md-7 sima-fade sima-fade--5">
        <div class="sima-card">
            ...
            <div class="sima-card__body">
                ...
                @empty
                {{-- Dummy Announcements --}}
                <div class="sima-announce" onclick="window.location='{{ route('mahasiswa.announcement') }}'">
                    <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:5px">
                    ...
                    <div class="sima-announce__body">
                        Orientasi dilaksanakan Senin, 24 Februari 2026 pukul 08.00 WIB di Aula Utama Gedung Rektorat. Seluruh mahasiswa asing wajib hadir membawa dokumen identitas asli dan KTM.
                    </div>
                    <div class="sima-announce__meta">
                        <i class="fas fa-clock"></i> 2 jam lalu
                        <span class="sima-badge sima-badge--amber">Penting</span>
                        <a href="{{ route('mahasiswa.announcement') }}" style="margin-left:auto;font-size:12px;color:var(--c-blue);font-weight:500">Selengkapnya →</a>
                    </div>
                </div>
                ...
                <div class="sima-announce" onclick="window.location='{{ route('mahasiswa.announcement') }}'">
                    ...
                    <div class="sima-announce__body">
                        Ujian Tengah Semester dilaksanakan 10–21 Maret 2026. Kartu ujian diambil mulai 3 Maret di bagian akademik dengan menunjukkan KTM asli.
                    </div>
                    <div class="sima-announce__meta">
                ...
                <div class="sima-announce" onclick="window.location='{{ route('mahasiswa.announcement') }}'">
                    ...
                    <div class="sima-announce__body">
                        Pendaftaran kelas BIPA B2 dibuka mulai 20 Februari 2026 melalui portal SIMA. Kuota terbatas 20 mahasiswa, seleksi 22 Februari 2026.
                    </div>
                    <div class="sima-announce__meta">
    ...
    <div class="col-md-5 sima-fade sima-fade--6">
        <div class="sima-card">
            <div class="sima-card__header">
                ...
                <a href="{{ route('mahasiswa.profil.dokumen') }}" class="sima-card__action">
            ...
            <div class="sima-card__body" style="padding:0">
                ...
                <table class="sima-table">
                    ...
                    <tbody>
                        @foreach($docs as $doc)
                        @php
                            $s = is_array($doc) ? $doc : $doc->toArray();
                            $status = $s['status'];
                            $info = $sm[$status] ?? $sm['pending'];
                        @endphp
                        <tr onclick="window.location='{{ route('mahasiswa.profil.dokumen') }}'"
                ...
                <div style="padding:14px 20px;border-top:1px solid var(--c-border-soft);display:flex;align-items:center;justify-content:space-between">
                    <span style="font-size:12px;color:var(--c-text-3)">
                        ...
                        Klik baris untuk detail dokumen
                    </span>
                    <a href="{{ route('mahasiswa.request.create') }}" class="sima-btn sima-btn--gold sima-btn--sm">
...
{{-- ═══════════════════════════════════════════════════
     ROW 4 — Analitik Cepat Kehadiran per Matkul
     ═══════════════════════════════════════════════════ --}}
<div class="row g-3">
        ...
        <div class="sima-card">
            <div class="sima-card__header">
                ...
                <a href="{{ route('mahasiswa.analytics') }}" class="sima-card__action">
                    <i class="fas fa-chart-bar"></i> Analitik Lengkap
                </a>
            </div>
            <div class="sima-card__body">
                    ...
                    <div class="col-md-6">
                        <div style="padding:14px;background:var(--c-surface-2);border-radius:11px;border:1px solid var(--c-border-soft)">
                            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:9px">
                                ...
                                <div style="font-family:var(--f-mono);font-size:17px;font-weight:700;color:{{ $m['color'] }}">
                                    {{ $m['pct'] }}%
                                </div>
                            </div>
                            <div class="sima-prog">
                                <div class="sima-prog__bar" data-w="{{ $m['pct'] }}"
                                     style="background:{{ $m['color'] }}"></div>
                            </div>
                            @if($m['pct'] < 80)
                            <div style="font-size:10.5px;color:var(--c-red);margin-top:5px;display:flex;align-items:center;gap:4px">
                                <i class="fas fa-triangle-exclamation"></i> Di bawah batas minimum
                            </div>
                            @elseif($m['pct'] < 85)
                            <div style="font-size:10.5px;color:var(--c-amber);margin-top:5px;display:flex;align-items:center;gap:4px">
                                <i class="fas fa-exclamation-circle"></i> Perlu ditingkatkan
                            </div>
                            @else
                            <div style="font-size:10.5px;color:var(--c-green);margin-top:5px;display:flex;align-items:center;gap:4px">
                                <i class="fas fa-circle-check"></i> Kehadiran baik
                            </div>
                            @endif
                        </div>
                    </div>
        ...
        <div class="sima-card">
            ...
            <div>
                ...
                <a href="{{ route('mahasiswa.notifikasi') }}"
                   style="display:flex;align-items:flex-start;gap:12px;padding:13px 20px;
                          border-bottom:1px solid var(--c-border-soft);
                          background:{{ ($nr['unread'] ?? false) ? 'rgba(37,99,235,.025)' : 'transparent' }};
                          text-decoration:none;transition:background .13s"
                   onmouseover="this.style.background='var(--c-surface-2)'"
                   onmouseout="this.style.background='{{ ($nr['unread'] ?? false) ? 'rgba(37,99,235,.025)' : 'transparent' }}'">

                    <div style="width:32px;height:32px;border-radius:9px;background:{{ $nr['bg'] }};color:{{ $nr['cl'] }};
                                display:flex;align-items:center;justify-content:center;font-size:13px;flex-shrink:0">
                        <i class="fas {{ $nr['ic'] }}"></i>
                    </div>

                    <div style="flex:1;min-width:0">
                        <div style="font-size:12.5px;color:var(--c-text-1);line-height:1.5;margin-bottom:3px;
                                    {{ ($nr['unread'] ?? false) ? 'font-weight:500' : '' }}">
                            {!! $nr['text'] !!}
                        </div>
                        <div style="font-family:var(--f-mono);font-size:10px;color:var(--c-text-3)">
                            {{ $nr['time'] }}
                        </div>
                    </div>

                    @if($nr['unread'] ?? false)
                    <div style="width:7px;height:7px;border-radius:50%;background:var(--c-blue);flex-shrink:0;margin-top:5px"></div>
                    @endif
...
@section('page_js')
<script>
/* ── Live "Sedang Berjalan" Indicator ─────────────── */
(function () {
    const now = new Date();
