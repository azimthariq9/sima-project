    ...
    <div class="col-md-5 sima-fade sima-fade--6">
        <div class="sima-card">
            <div class="sima-card__header">
                ...
                <a href="{{ route('mahasiswa.profil.dokumen') }}" class="sima-card__action"><i class="fas fa-folder-open"></i> Kelola</a>
            </div>
            <div class="sima-card__body" style="padding:0">
                ...
                <table class="sima-table">
                    ...
                    <tbody>
                        ...
                        <tr onclick="window.location='{{ route('mahasiswa.profil.dokumen') }}'" style="cursor:pointer">
                            <td>
